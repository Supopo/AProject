...
public abstract class BaseActivity<V extends ViewDataBinding, VM extends BaseViewModel> extends RxAppCompatActivity implements IBaseView {
    ...
    private void setImageBack() {
        tvTitle = baseBinding.getRoot().findViewById(R.id.toolbar_title);
        rlRoot = baseBinding.getRoot().findViewById(R.id.rl_root);
        rlLeft = baseBinding.getRoot().findViewById(R.id.rl_left);
